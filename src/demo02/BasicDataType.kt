...
fun main(args: Array<String>) {
	...
	val oneMilltion = 1_000_000
	val creditCardNumber = 1234_5678_9012_34567L
...
//	如下所示，我们分别是两种方式创建了两个数组：
	val ayy = arrayOf(1,2,3)
	val byy = Array(3,{i -> (i * 2) })
...
//  Kotlin 支持三个引号 """ 扩起来的字符串，支持多行字符串，比如：
    ...
    |多行字符串
    """.trimMargin()
	println(text01)    // 前置空格删除了
	println("=======================字符串模板======================")
//	字符串可以包含模板表达式 ，即一些小段代码，
//	会求值并把结果合并到字符串中。
